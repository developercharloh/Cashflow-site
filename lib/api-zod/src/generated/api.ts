...
export const LoginResponse = zod.object({
  ...
  "welcomeGiftClaimed": zod.boolean(),
 ...
 */
export const ClaimWelcomeGiftResponse = zod.object({
  "message": zod.string()
})
...
export const GetTasksResponseItem = zod.object({
  ...
  "cooldownHours": zod.number().nullish(),
  "onCooldown": zod.boolean().optional(),
 ...
 */
export const ChargeDepositBody = zod.object({
  "amount": zod.number(),
  "phone": zod.string(),
  "provider": zod.string()
})

export const ChargeDepositResponse = zod.object({
  "status": zod.string(),
  "reference": zod.string(),
 ...
 */
export const PaystackWithdrawMobileBody = zod.object({
  "amount": zod.number(),
  "phone": zod.string(),
  "provider": zod.enum(['mpesa', 'airtel'])
})

export const PaystackWithdrawMobileResponse = zod.object({
  "id": zod.number(),
  "status": zod.string(),
  "amount": zod.number(),
  "description": zod.string(),
...
export const GetKycStatusResponse = zod.object({
  ...
  "kycSessionId": zod.string().optional()
})
 ...
 */
export const UploadKycDocumentsBody = zod.object({
  "fullName": zod.string(),
  "dateOfBirth": zod.string(),
  "country": zod.string(),
  "phoneNumber": zod.string(),
  ...
  "frontIdImage": zod.string(),
  "backIdImage": zod.string().nullish()
})
 ...
 */
export const GetKycSubmissionsResponseItem = zod.object({
  "id": zod.number(),
  "userId": zod.number(),
  ...
  "phoneNumber": zod.string(),
  "nationalId": zod.string(),
  "submissionMethod": zod.string().optional(),
  "documentType": zod.string().nullish(),
  "frontIdUrl": zod.string().nullish(),
  "backIdUrl": zod.string().nullish(),
...
export const GetKycSubmissionsResponse = zod.array(GetKycSubmissionsResponseItem)


/**
 * @summary Admin — approve, reject, or request resubmission
 */
export const ReviewKycSubmissionParams = zod.object({
  "id": zod.coerce.number()
})

export const ReviewKycSubmissionBody = zod.object({
  "action": zod.string(),
